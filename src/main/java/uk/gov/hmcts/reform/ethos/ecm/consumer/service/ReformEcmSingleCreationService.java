...
public class ReformEcmSingleCreationService {
    ...
    public void sendCreation(SubmitEvent oldSubmitEvent, String accessToken, UpdateCaseMsg updateCaseMsg)
        ...
        var transferToReformECMDataModel = ((TransferToReformECMDataModel) updateCaseMsg.getDataModelParent());
        String caseTypeId = transferToReformECMDataModel.getOfficeCT();
        String positionType = transferToReformECMDataModel.getPositionType();
        ...
        transferCase(oldSubmitEvent, caseId, caseTypeId, ccdGatewayBaseUrl, positionType, reasonForCT,
    ...
    private void transferCase(SubmitEvent oldSubmitEvent, String caseId, String caseTypeId, String ccdGatewayBaseUrl,
                              String positionType, String reasonForCT, String jurisdiction, String accessToken,
